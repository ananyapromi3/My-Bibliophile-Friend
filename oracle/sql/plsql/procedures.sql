...
EXCEPTION
	...
	WHEN OTHERS THEN
		MSG := 'UNKNOWN ERROR';
END;
CREATE OR REPLACE PROCEDURE CREATE_OFFER(MSG IN VARCHAR2, PHOTO IN VARCHAR2, ID IN NUMBER, ISBN IN VARCHAR2, MSG2 OUT VARCHAR2, PHOTO1 IN VARCHAR2, PHOTO2 IN VARCHAR2, PHOTO3 IN VARCHAR2, PHOTO4 IN VARCHAR2) IS
	PHT1 VARCHAR2(500);
	PHT2 VARCHAR2(500);
	PHT3 VARCHAR2(500);
	PHT4 VARCHAR2(500);
...
EXCEPTION
	...
	WHEN OTHERS THEN
		MSG := 'UNKNOWN ERROR';
END;
CREATE OR REPLACE PROCEDURE DELETE_EXCHANGEOFFER (EXCHANGE_ID IN NUMBER, MSG OUT VARCHAR2) IS
BEGIN
...
EXCEPTION
	...
	WHEN OTHERS THEN
		MSG := 'UNKNOWN ERROR';
END;
CREATE OR REPLACE PROCEDURE DELETE_OFFER (OFFER_ID IN NUMBER, MSG OUT VARCHAR2) IS
BEGIN
	DELETE FROM OFFER
	WHERE
		OFFERID = OFFER_ID;
...
EXCEPTION
	...
	WHEN OTHERS THEN
		MSG := 'UNKNOWN ERROR';
END;
CREATE OR REPLACE PROCEDURE UPDATE_PASS (EMAIL IN VARCHAR2, OLDPASS IN VARCHAR2, NEWPASS IN VARCHAR2, MSG OUT VARCHAR2) IS
	PASS VARCHAR2(500);
BEGIN
	SELECT
	...
	END IF;
END;
CREATE OR REPLACE PROCEDURE DECLINE_OFFER(NOTIID IN NUMBER, MSG OUT VARCHAR2) IS
BEGIN
...
EXCEPTION
	...
	WHEN OTHERS THEN
		MSG := 'UNKNOWN ERROR';
END;
CREATE OR REPLACE PROCEDURE DELETE_USER (EMAIL IN VARCHAR2, MSG OUT VARCHAR2) IS
BEGIN
	DELETE FROM USERMAN
	WHERE
		EMAILID = EMAIL;
...
EXCEPTION
	...
	WHEN OTHERS THEN
		MSG := 'UNKNOWN ERROR';
END;
CREATE OR REPLACE PROCEDURE DELETE_BOOK (ISBN_NO IN VARCHAR2, MSG OUT VARCHAR2) IS
BEGIN
	DELETE FROM BOOK
	WHERE
		ISBN = ISBN_NO;
