...
-- ----------------------------
ALTER TABLE "PROJECT"."NOTI" ADD CONSTRAINT "FK_NOTI_EMAIL" FOREIGN KEY ("EMAILID") REFERENCES "PROJECT"."USERMAN" ("EMAILID") ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;